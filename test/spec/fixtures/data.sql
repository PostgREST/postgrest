...
TRUNCATE TABLE test.body_delete_items_cpk CASCADE;
INSERT INTO test.body_delete_items_cpk (id, name, observation) VALUES (1, 'item-1', NULL), (2, 'item-2', NULL), (3, 'item-3', NULL);

...
ALTER ROLE db_config_authenticator SET pgrst.url_use_legacy_target_names = 'false';
...
ALTER ROLE other_authenticator SET pgrst.url_use_legacy_target_names = 'false';

...
data AppState = AppState
  ...
  , stateMainThreadId     :: Weak ThreadId
...
killMainThread :: AppState -> IO ()
killMainThread AppState{stateMainThreadId} =
  deRefWeak stateMainThreadId >>= foldMap killThread

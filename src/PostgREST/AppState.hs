...
data TracerState = TracerState {ts'enabled :: Bool, ts'otelTracer :: Maybe Tracer} deriving (Show)

emptyTracerState :: TracerState
emptyTracerState = TracerState {ts'enabled = False, ts'otelTracer = Nothing }
